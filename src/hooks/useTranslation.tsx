...
const translations = {
  ...
  ES: {
    ...
    // Form fields
    'form.tripType': '¿Qué tipo de viaje estás planeando?',
    'form.party': 'Fiesta / Social',
    'form.romantic': 'Escapada Romántica',
    'form.business': 'Negocios / Networking',
    'form.cultural': 'Cultural / Aventura',
    'form.wellness': 'Bienestar / Spa',
    'form.custom': 'Visión Personalizada',
    'form.selectPackage': '¿Te interesa algún paquete específico?',
    'form.noPreference': 'Sin preferencia - sorpréndeme',
    'form.groupSize': 'Tamaño del Grupo',
    'form.groupSizePlaceholder': 'ej., 4 personas',
    'form.budget': 'Presupuesto por persona (USD)',
    'form.budgetPlaceholder': 'ej., $800',
    'form.travelDates': 'Fechas de Viaje',
    'form.startDate': 'Fecha de Inicio',
    'form.endDate': 'Fecha de Fin',
    'form.flexible': 'Soy flexible con las fechas',
    'form.packageType': 'Preferencia de Tipo de Paquete',
    'form.essential': 'Esencial (Económico)',
    'form.premium': 'Premium (Mejorado)',
    'form.luxury': 'Lujo (Sofisticado)',
    'form.vipExclusive': 'VIP Exclusivo',
    'form.additionalServices': 'Servicios Adicionales (Opcional)',
    'form.airportTransfer': 'Traslado al aeropuerto',
    'form.carRental': 'Alquiler de auto',
    'form.tourGuide': 'Guía turístico personal',
    'form.photographer2': 'Fotógrafo profesional',
    'form.translator': 'Traductor',
    'form.emergencySupport': 'Soporte de emergencia 24/7',
    'form.contactPreference': '¿Cómo deberíamos contactarte?',
    'form.whatsapp': 'WhatsApp',
    'form.email': 'Email',
    'form.instagram': 'Instagram',
    'form.whatsappPlaceholder': '+1234567890',
    'form.emailPlaceholder': 'tu@email.com',
    'form.instagramPlaceholder': '@tuusuario',
    'form.additionalInfo': '¿Algo más que deberíamos saber?',
    'form.additionalInfoPlaceholder': 'Solicitudes especiales, preferencias, restricciones dietéticas, etc.'
  },
  ZH: {
    // Navigation
    'nav.home': '首页',
